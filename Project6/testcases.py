...
from Project6.Graph import Graph, Vertex, AStarPriorityQueue
...
class GraphTests(unittest.TestCase):
    ...
    def test_equivalence_relation(self):
        ...
        # self.assertEqual(new_matrix, [[None, 'a', 'b', 'c', 'd', 'e'],
        #                               ['a', 1, None, None, None, None],
        #                               ['b', None, 1, None, None, None],
        #                               ['c', None, None, 1, None, None],
        ...
        # self.assertEqual(count, 5)
        # new_matrix = graph.graph2matrix()
        # self.assertEqual(new_matrix, [[None, 'a', 'b', 'c'],
        #                               ['a', 1, 1, None],
        #                               ['b', 1, 1, 1],
        #                               ['c', None, 1, 1]])

        # matrix = [[None, 'a', 'b', 'c', 'd', 'e', 'f', 'g'],
        #           ['a', None, None, None, None, None, None, None],
        #           ['b', 1, None, None, None, None, None, None],
        #           ['c', None, 1, None, None, None, None, None],
        #           ['d', None, None, 1, None, None, None, None],
        ...
        # count = graph.make_equivalence_relation()
        # new_matrix = graph.graph2matrix()
        # self.assertEqual(new_matrix, [[None, 'a', 'b', 'c', 'd', 'e', 'f', 'g'],
        #                               ['a', 1, 1, 1, 1, None, None, None],
        #                               ['b', 1, 1, 1, 1, None, None, None],
        #                               ['c', 1, 1, 1, 1, None, None, None],
        #                               ['d', 1, 1, 1, 1, None, None, None],
        #                               ['e', None, None, None, None, 1, None, None],
        #                               ['f', None, None, None, None, None, 1, None],
        #                               ['g', None, None, None, None, None, None, 1]])
        # count = graph.make_equivalence_relation()
        #
